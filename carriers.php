<div class="card">
    <div class="card-header d-flex justify-content-between">
        <h3 class="card-title">Carrier List</h3>
    ...
    <div class="card-body">
        <table class="table table-hover table-striped table-bordered">
            ...
            <tbody>
                <?php 
                $sql = "SELECT * FROM `carrier_list`  order by `name` asc";
                $qry = $conn->query($sql);
                $i = 1;
                ...
                <tr>
                    ...
                    <td class="py-1 px-2 text-truncate" title="<?php echo $row['address'] ?>"><?php echo $row['address'] ?></td>
                    ...
                    <th class="text-center py-1 px-2">
                        <div class="btn-group" role="group">
                            ...
                            <li><a class="dropdown-item edit_data" data-id = '<?php echo $row['carrier_id'] ?>' href="javascript:void(0)">Edit</a></li>
                            <li><a class="dropdown-item delete_data" data-id = '<?php echo $row['carrier_id'] ?>' data-name = '<?php echo $row['name'] ?>' href="javascript:void(0)">Delete</a></li>
                            </ul>
                        </div>
                    </th>
                </tr>
...
<script>
    $(function(){
        $('#create_new').click(function(){
            uni_modal('Add New Carrier/Delivery Rider',"manage_carrier.php")
        })
        $('.edit_data').click(function(){
            uni_modal('Edit Carrier/Delivery Rider Details',"manage_carrier.php?id="+$(this).attr('data-id'))
        })
    ...
    function delete_data($id){
        ...
        $.ajax({
            url:'./Actions.php?a=delete_carrier',
            method:'POST',
            data:{id:$id},
            dataType:'JSON',
            error:err=>{
