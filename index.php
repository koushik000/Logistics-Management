...
<head>
    ...
    <title><?php echo ucwords(str_replace('_',' ',$page)) ?> | Logistic Hub Parcels  Management System</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./?page=parcels">Parcel List</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle  <?php echo (in_array($page,array('users','carriers')))? 'active' : '' ?>" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Master List</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="./?page=parcel_types">Parcel Type</a></li>
                            <div class="dropdown-divider"></div>
                            <li><a class="dropdown-item" href="./?page=carriers">Carriers</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
